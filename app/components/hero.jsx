        ...
        <div className={`${styles.padding} h-full w-full `}>
          ...
          <div className={`w-full text-center flex flex-col items-center justify-center space-y-4 py-24 px-8`}>
            ...
            <Button
              ...
              className={`w-[20rem] flex items-center justify-center translate-y-4 hover:bg-cmprimary/20 hover:translate-y-3 rounded-full border-2 border-cmprimary hover:font-medium cursor-pointer py-4 px-8 bg-cmprimary active:translate-y-2 transition duration-300 ease-linear transform`}
            >
